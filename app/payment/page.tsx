  ...
  return(
    <>
      ...
      <Navbar />
        ...
        <div className="flex flex-col text-white text-center max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 font-mono h-full">
      
          <h1 className="font-bold text-5xl">Choose a payment method</h1>

          <div className="flex flex-col md:flex-row justify-between pt-16">
            <div className="flex flex-col w-1/4">
                <h1 className="font-bold text-3xl pb-5">Credit/Debit Card</h1>
                <div className="mb-6 grid grid-cols-2 gap-4 bg-white rounded-md p-5">
                    ...
                    <input type="number" id="cvv-input" aria-describedby="helper-text-explanation" className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 " placeholder="•••" required />
                </div>
            </div>
            <Link href="/confirmation" className="flex w-full items-center justify-center rounded-lg bg-sky-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800">Continue</Link>
            </div>

            <div className="flex flex-col w-1/4">
                <h1 className="font-bold text-3xl pb-5">Imperial Credits</h1>
                <div className="flex flex-col bg-white rounded-md p-5 ">
                    <div className="col-span-2 sm:col-span-1 justify-center">
                        <label htmlFor="card-number-input" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white">ID Number* </label>
                        <input type="text" id="card-number-input" className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pe-10 text-sm text-gray-900" placeholder="xxxx-xxxx-xxxx-xxxx" pattern="^4[0-9]{12}(?:[0-9]{3})?$" required />
                    </div>
                </div>
                <Link href="/confirmation" className="mt-3 flex w-full items-center justify-center rounded-lg bg-sky-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800">Continue</Link>
            </div>

            <div className="flex flex-col w-1/4">
                <h1 className="font-bold text-3xl pb-5">First Born</h1>
                <div className="flex flex-col bg-white rounded-md p-5 ">
                    <div className="col-span-2 sm:col-span-1 justify-center">
                        <label htmlFor="first-born-name" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Full Name* </label>
                        <input type="text" id="first-born-name" className="mb-2 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500" placeholder="Bonnie Green" required />                   
                    </div>
                    <div className="col-span-2 sm:col-span-1 justify-center">
                        <label htmlFor="first-born-age" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Age* </label>
                        <input type="text" id="first-born-age" className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500" required />                   
                    </div>
                </div>
                <Link href="/confirmation" className="mt-3 flex w-full items-center justify-center rounded-lg bg-sky-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800">Continue</Link>
            </div>
